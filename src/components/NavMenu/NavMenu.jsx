  ...
  return (
    <nav>
      <ul className={classNames(styles.nav, className)}>
        <NavLink to=''><li className={styles.menuItem}>
        ...
        <NavLink to='/catalog/1/'> <li className={styles.menuItem}>
        ...
        <NavLink to='/gallery-card/1'> <li className={styles.menuItem}>
        ...
        <NavLink to='contacts'>  <li className={styles.menuItem}>
